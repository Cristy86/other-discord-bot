...
class Pages:
    ...
    def __init__(self, ctx, *, entries, per_page=12, show_entry_count=True):
        ...
        self.embed = discord.Embed(colour=0x000000)
...
class HelpPaginator(Pages):
    ...
    async def show_page(self, page, *, first=False):
        ...
        if hasattr(self, '_is_bot'):
            value ='For more help, join the official bot support server: [Click](https://discord.gg/tB8w8PZ)\nThis is taken from R. Danny made by Danny#0007. You can check the source: [Click](https://github.com/Rapptz/RoboDanny)'
